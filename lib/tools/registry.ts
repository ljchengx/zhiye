...
export const toolDefinitions: readonly ToolDefinition[] = [
  ...
  },
  {
    ...
    seo: {
      ...
      summary: "生成每天一张的 30 天数学练习，覆盖相邻数、比大小、四种口算方法，并逐步加入 200 以内三个数加减混合。",
      intro: "知页数学练习工具适合幼小阶段和低年级日常练习。工具按 6 个阶段安排 30 天连续作业，每天一张不超过 30 题的 A4 练习纸；难度从 20 以内基础口算逐步提升到 200 以内三个数加减混合，也可以点选某一天查看或自选当天主题，最后一次打印导出完整 30 页 PDF。",
      features: [
        "相邻数：生成如“26 __ 28”的填中间数题目。",
        "比大小：生成 100 以内数字的比较题，覆盖小于、大于和等于。",
        "口算：按凑十法、破十法、平十法、想加算减法安排演示，逐步加入两位数和三个数加减混合。",
        "连续作业：按 6 个阶段生成 30 天内容，每天一张，支持查看当天或一次导出完整打印包。",
      ],
      steps: [
      ...
      sections: [
        ...
        },
        {
          heading: "四种口算方法",
          paragraphs: [
            "凑十法适合处理进位加法；破十法和平十法常用于退位减法；想加算减法通过逆向思考加法关系，帮助孩子理解减法。计划先巩固基础题，再逐步加入两位数和三个数加减混合，后期结果控制在 200 以内。",
          ],
        },
        {
          heading: "A4 练习纸与本地处理",
      ...
      faqs: [
        ...
        {
          question: "口算题支持哪些方法？",
          answer: "计划按阶段安排凑十法、破十法、平十法和想加算减法，并在阶段小结中混合练习；点击主题卡片可以自选当天主题。后期会加入 200 以内三个数加减混合，每张练习纸上方都有当天主题的简单演示。",
        },
        {
